...
import beam232001.monerominer9000.Config;
import beam232001.monerominer9000.Tools;
...
/**
 * ccminer executable based monero mining service
 */
public class MoneroBinMiningService extends AbstractMiningService {

    private static final String LOG_TAG = "MiningSvc";

    private static final String miner_ccminer = "ccminer";
    private static final String algo = "monero";
    ...
    public class MoneroBinMiningServiceBinder extends AbstractMiningServiceBinder {
        @Override
        public AbstractMiningService getService() {
            return MoneroBinMiningService.this;
        }
    }
    ...
    public IBinder onBind(Intent intent) {
        return new MoneroBinMiningServiceBinder();
    }
    ...
    private void startMiningProcess(MiningConfig config) {
        ...
        try {
            ...
            outputHandler = new MoneroBinMiningService.OutputReaderThread(process.getInputStream());
            outputHandler.start();

            inputHandler = new MoneroBinMiningService.InputReaderThread(process.getOutputStream());
            inputHandler.start();
